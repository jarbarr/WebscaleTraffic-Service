...
function writeNProperties(n, writer, encoding, callback) {
  let i = n;
  let id = 0;
...
function writeNReservations(array1, array2, array3) {
...
writeNProperties(100, writeProperties, 'utf-8', () => {
  writeProperties.end();
});

const writeReservations = fs.createWriteStream('./reservations.csv');
writeReservations.write('booking_id, property_id, booked_date, total, guests \n');
