  ...
  getRoomData(roomID) {
    $.get(`/rooms/${roomID}/reservation`, (data) => {
      ...
      this.setState({
         ...
         * In the db pulled from DockerHub, retrieved date is formated 2020-09-01T00:00:00.000Z,
         * when transformed to moment object, it will be ROUNDED to the last date (2020-08-31).
